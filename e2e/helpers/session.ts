...
export type E2ELegacyVersionTwoSessionInput = E2ESessionInput & {
...
export async function createLegacyVersionTwoSessionToken(
  input: E2ELegacyVersionTwoSessionInput,
): Promise<string> {
  return createSignedToken({
    purpose: "SESSION",
    version: 2,
