...
export const metadata: Metadata = {
  ...
  description:
    "Academic performance goals and parent testimonials for ULU Online School.",
};
        ...
        <div className="container grid gap-6">
          <Card>
            ...
            <CardContent className="space-y-3 text-sm text-muted-foreground">
              <p>ULU students are prepared for IGCSE examinations and international university pathways.</p>
